...
export const ASSISTANT_TOOL_SCHEMAS = {
    ...
    borrowed_machines: z.object({
        ...
        status: z
            ...
            .optional(),
        dueState: z.enum(['overdue', 'due_soon', 'missing_due']).optional(),
        partnerName: optionalText(180),
        batchCode: optionalText(80),
        machineRef: optionalText(200),
        plantName: optionalText(),
        period,
        startDate: date,
        endDate: date,
...
export const ASSISTANT_TOOL_SUMMARY: Record<AssistantToolName, string> = {
    ...
    borrowed_machines: 'Lô và máy mượn/thuê/cho mượn, duyệt-giao-trả và hạn trả đối tác',
...
const ASSISTANT_TOOL_ARGUMENT_GUIDE: Record<AssistantToolName, string> = {
    ...
    borrowed_machines:
        '{direction?:all|inbound|outbound, status?:open|draft|receiving|pending_approval|approved|active|partially_returned|returned|rejected|cancelled, dueState?:overdue|due_soon|missing_due, partnerName?, batchCode?, machineRef?, plantName?, period?, startDate?, endDate?, limit?}',
