...
router.get('/push/devices', asyncHandler(webPushService.getDevices));
router.post('/push/sync', asyncHandler(webPushService.syncDevice));
...
router.patch('/push/devices/:id', validateObjectId, asyncHandler(webPushService.updateDevice));
router.delete('/push/devices/:id', validateObjectId, asyncHandler(webPushService.deactivateDevice));
